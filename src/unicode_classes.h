 ...
 *
 * Unicode 16.0.0, via CPython's unicodedata.
 *
...
/* letters — \p{L}: 677 ranges */
static const uc_range uc_l[] = {
...
/* combining marks — \p{M}: 321 ranges */
static const uc_range uc_m[] = {
...
/* numbers — \p{N}, every script's digits and the numeric symbols: 144 ranges */
static const uc_range uc_n[] = {
...
/* punctuation — \p{P}: 198 ranges */
static const uc_range uc_p[] = {
    ...
    {0x1CD3,0x1CD3}, {0x2010,0x2027}, {0x2030,0x2043}, {0x2045,0x2051},
    {0x2053,0x205E}, {0x207D,0x207E}, {0x208D,0x208E}, {0x2308,0x230B},
    {0x2329,0x232A}, {0x2768,0x2775}, {0x27C5,0x27C6}, {0x27E6,0x27EF},
    {0x2983,0x2998}, {0x29D8,0x29DB}, {0x29FC,0x29FD}, {0x2CF9,0x2CFC},
    {0x2CFE,0x2CFF}, {0x2D70,0x2D70}, {0x2E00,0x2E2E}, {0x2E30,0x2E4F},
    {0x2E52,0x2E5D}, {0x3001,0x3003}, {0x3008,0x3011}, {0x3014,0x301F},
    ...
    {0x10B39,0x10B3F}, {0x10B99,0x10B9C}, {0x10D6E,0x10D6E}, {0x10EAD,0x10EAD},
...
/* symbols — \p{S}, currency and math included: 236 ranges */
static const uc_range uc_s[] = {
    ...
    {0x2190,0x2307}, {0x230C,0x2328}, {0x232B,0x2429}, {0x2440,0x244A},
    ...
    {0x31C0,0x31E5}, {0x31EF,0x31EF}, {0x3200,0x321E}, {0x322A,0x3247},
    ...
    {0x10D8E,0x10D8F}, {0x1173F,0x1173F}, {0x11FD5,0x11FF1}, {0x16B3C,0x16B3F},
    {0x16B45,0x16B45}, {0x1BC9C,0x1BC9C}, {0x1CC00,0x1CCEF}, {0x1CD00,0x1CEB3},
